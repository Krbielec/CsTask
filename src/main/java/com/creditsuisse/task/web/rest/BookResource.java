...
import com.creditsuisse.task.service.BookQueryService;
import com.creditsuisse.task.service.BookService;
...
/**
 * REST controller for managing {@link com.creditsuisse.task.domain.Book}.
 */
@RestController
@RequestMapping("/api")
